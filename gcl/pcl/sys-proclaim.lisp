...
(PROCLAIM
    '(FTYPE (FUNCTION (T T T) T) NOTE-PV-TABLE-REFERENCE
            ...
            ONE-INDEX-DFUN-INFO ONE-CLASS-DFUN-INFO
            |(FAST-METHOD COMPUTE-CLASS-PRECEDENCE-LIST (SLOT-CLASS))|
            MAP-ALL-ORDERS CAN-OPTIMIZE-ACCESS SKIP-FAST-SLOT-ACCESS-P
            ...
            EMIT-1-T-DLAP MAKE-METHOD-INITARGS-FORM-INTERNAL
            ENTRY-IN-CACHE-P CONVERT-TABLE MAKE-METHOD-SPEC
            TRACE-EMF-CALL-INTERNAL FLUSH-CACHE-TRAP
...
(PROCLAIM
    '(FTYPE (FUNCTION (T) *) EMIT-CONSTANT-VALUE PCL-DESCRIBE
            GET-GENERIC-FUNCTION-INFO EARLY-METHOD-FUNCTION
...
(PROCLAIM
    '(FTYPE (FUNCTION (T) T) VARIABLE-GLOBALLY-SPECIAL-P
            ...
            CLASS-OF EXTRACT-PARAMETERS CHECK-WRAPPER-VALIDITY
            CLASS-PREDICATE UNPARSE-SPECIALIZERS
            EXTRACT-REQUIRED-PARAMETERS %SYMBOL-FUNCTION
            MAKE-CLASS-EQ-PREDICATE INTERN-EQL-SPECIALIZER
            FINAL-ACCESSOR-DFUN-TYPE TWO-CLASS-WRAPPER1
            COMPLICATED-INSTANCE-CREATION-METHOD MAKE-EQL-PREDICATE
            DEFAULT-STRUCTUREP EXTRACT-LAMBDA-LIST CHECKING-FUNCTION
            UPDATE-GF-INFO BOOTSTRAP-ACCESSOR-DEFINITIONS CACHE-OWNER
            INITIALIZE-INFO-KEY DEFAULT-STRUCTURE-INSTANCE-P
            BOOTSTRAP-CLASS-PREDICATES DEFAULT-STRUCTURE-TYPE
            GET-BUILT-IN-CLASS-SYMBOL STRUCTURE-TYPE
            INITIALIZE-INFO-WRAPPER COMPUTE-STD-CPL-PHASE-2
            GET-BUILT-IN-WRAPPER-SYMBOL NET-TEST-CONVERTER
            GET-PV-CELL-FOR-CLASS DO-STANDARD-DEFSETF-1
            FAST-INSTANCE-BOUNDP-P WALKER::GET-WALKER-TEMPLATE
            MAKE-INSTANCE-FUNCTION-SYMBOL INTERN-FUNCTION-NAME
            MAKE-FUNCTION-INLINE INITIALIZE-INFO-CACHED-RI-VALID-P
            EXTRACT-SPECIALIZER-NAMES UPDATE-ALL-C-A-M-GF-INFO
            CHECKING-CACHE METHOD-FUNCTION-PV-TABLE
            EARLY-SLOT-DEFINITION-NAME UPDATE-PV-TABLE-CACHE-INFO
            CONSTANT-VALUE-CACHE LIST-LARGE-CACHE
            INITIALIZE-INFO-CACHED-INITARGS-FORM-LIST DFUN-INFO-CACHE
            EARLY-CLASS-SLOTS METHOD-FUNCTION-METHOD SLOT-READER-SYMBOL
            NO-METHODS-CACHE COMPILE-LAMBDA-DEFERRED STORE-FGEN
            INITIALIZE-INFO-CACHED-NEW-KEYS ARG-INFO-APPLYP
            WRAPPER-FIELD GF-INFO-C-A-M-EMF-STD-P
            CLASS-PRECEDENCE-DESCRIPTION-P GBOUNDP CACHING-DFUN-COST
            FUNCALLABLE-INSTANCE-P ONE-CLASS-P UPDATE-C-A-M-GF-INFO
            INITIAL-CACHE STRUCTURE-TYPE-INTERNAL-SLOTDS
            INFORM-TYPE-SYSTEM-ABOUT-STD-CLASS GMAKUNBOUND
            UNENCAPSULATED-FDEFINITION SHOW-DFUN-COSTS
            MAKE-DEFAULT-METHOD-GROUP-DESCRIPTION
            INITIALIZE-INFO-CACHED-DEFAULT-INITARGS-FUNCTION
            METHOD-FUNCTION-NEEDS-NEXT-METHODS-P GF-INFO-FAST-MF-P
            DFUN-INFO-P
            MAKE-OPTIMIZED-STRUCTURE-SLOT-VALUE-USING-CLASS-METHOD-FUNCTION
            UPDATE-GF-SIMPLE-ACCESSOR-TYPE RESET-CLASS-INITIALIZE-INFO
            FTYPE-DECLARATION-FROM-LAMBDA-LIST
            EARLY-SLOT-DEFINITION-LOCATION NO-METHODS-P UNDEFMETHOD-1
            WALKER::ENV-WALK-FUNCTION WALKER::ENV-LOCK FGEN-GENSYMS
            GET-CACHE-VECTOR
            WALKER::GET-IMPLEMENTATION-DEPENDENT-WALKER-TEMPLATE
            UPDATE-GFS-OF-CLASS TWO-CLASS-P EARLY-COLLECT-CPL
            STRUCTURE-TYPE-INCLUDED-TYPE-NAME DEFAULT-CONSTANTP
            COUNT-DFUN CONSTANT-SYMBOL-P
            INITIALIZE-INFO-CACHED-SHARED-INITIALIZE-T-FUNCTION
            CACHING-P EARLY-COLLECT-SLOTS ARG-INFO-LAMBDA-LIST
            MAKE-INITIAL-DFUN STRUCTURE-TYPE-SLOT-DESCRIPTION-LIST
            FREE-CACHE-VECTOR MAKE-INITFUNCTION
            DO-STANDARD-DEFSETFS-FOR-DEFCLASS GFS-OF-TYPE ARG-INFO-P
            ARG-INFO-PRECEDENCE DEFAULT-METHOD-ONLY-P CACHE-P
            STRUCTURE-SLOTD-READER-FUNCTION
            MAKE-OPTIMIZED-STRUCTURE-SETF-SLOT-VALUE-USING-CLASS-METHOD-FUNCTION
            STANDARD-SVUC-METHOD LEGAL-CLASS-NAME-P
            EARLY-METHOD-LAMBDA-LIST ARG-INFO-METATYPES FGEN-TEST
            STRUCTURE-SLOTD-NAME METHOD-LL->GENERIC-FUNCTION-LL
            ITERATE::VARIABLES-FROM-LET
            INITIALIZE-INFO-CACHED-SHARED-INITIALIZE-NIL-FUNCTION
            STRUCTURE-TYPE-P ARG-INFO-VALID-P FGEN-GENERATOR-LAMBDA
            ...
            STRUCTURE-SLOTD-WRITER-FUNCTION METHOD-FUNCTION-PLIST
            ARG-INFO-KEYWORDS EARLY-GF-NAME CHECK-CACHE
            ACCESSOR-DFUN-INFO-P FIND-CYCLE-REASONS
            FORMAT-CYCLE-REASONS COPY-CACHE
            INITIALIZE-INFO-CACHED-COMBINED-INITIALIZE-FUNCTION
            DISPATCH-CACHE GF-DFUN-CACHE NEXT-WRAPPER-FIELD
            WALKER::ENV-LEXICAL-VARIABLES CLASS-FROM-TYPE
            CACHING-DFUN-INFO STRUCTURE-SLOTD-TYPE
            INITIALIZE-INFO-CACHED-MAKE-INSTANCE-FUNCTION
            EARLY-CLASS-DEFINITION GF-DFUN-INFO
            DEFAULT-METHOD-ONLY-CACHE FGEN-GENERATOR DNET-METHODS-P
            COMPUTE-APPLICABLE-METHODS-EMF-STD-P SETFBOUNDP
            INITIALIZE-INFO-CACHED-MAKE-INSTANCE-FUNCTION-SYMBOL
            ECD-SOURCE METHOD-CALL-P ACCESSOR-DFUN-INFO-CACHE
            FGEN-SYSTEM GET-SETF-FUNCTION-NAME CONSTANT-VALUE-DFUN-INFO
            METHOD-FUNCTION-FROM-FAST-FUNCTION INTERNED-SYMBOL-P
            ECD-METACLASS STRUCTURE-SLOT-BOUNDP
            ONE-INDEX-DFUN-INFO-CACHE LIST-DFUN USE-CACHING-DFUN-P
            RESET-CLASS-INITIALIZE-INFO-1
            ONE-INDEX-DFUN-INFO-ACCESSOR-TYPE GDEFINITION CPD-CLASS
            FUNCTION-RETURNING-NIL METHOD-CALL-CALL-METHOD-ARGS
            %FBOUNDP MAKE-PV-TYPE-DECLARATION FREE-CACHE
            KEYWORD-SPEC-NAME UPDATE-CLASS-CAN-PRECEDE-P
            EARLY-CLASS-PRECEDENCE-LIST ITERATE::SEQUENCE-ACCESSOR
            N-N-CACHE SLOT-BOUNDP-SYMBOL MAKE-CALLS-TYPE-DECLARATION
            PARSE-SPECIALIZERS METHODS-CONTAIN-EQL-SPECIALIZER-P
            %STD-INSTANCE-WRAPPER GENERIC-CLOBBERS-FUNCTION
            ACCESSOR-DFUN-INFO-ACCESSOR-TYPE MAP-SPECIALIZERS
            ONE-INDEX-DFUN-INFO-P N-N-ACCESSOR-TYPE
            RESET-INITIALIZE-INFO MAKE-TYPE-PREDICATE
            %STD-INSTANCE-SLOTS FAST-METHOD-CALL-PV-CELL
            ECD-CANONICAL-SLOTS SLOT-VECTOR-SYMBOL CCLOSUREP
            WRAPPER-FOR-STRUCTURE EVAL-FORM CPD-SUPERS PV-TABLEP
            ONE-CLASS-CACHE EARLY-METHOD-QUALIFIERS
            MAKE-PERMUTATION-VECTOR MAP-ALL-GENERIC-FUNCTIONS
            FAST-METHOD-CALL-NEXT-METHOD-CALL ONE-INDEX-DFUN-INFO-INDEX
            DEFAULT-TEST-CONVERTER STD-INSTANCE-P
            ONE-CLASS-ACCESSOR-TYPE PROCLAIM-INCOMPATIBLE-SUPERCLASSES
            STRUCTURE-OBJECT-P FAST-METHOD-CALL-P ONE-CLASS-INDEX
            ECD-OTHER-INITARGS EXPAND-LONG-DEFCOMBIN
            COMPUTE-MCASE-PARAMETERS BUILT-IN-WRAPPER-OF WRAPPER-OF
            EXPAND-MAKE-INSTANCE-FORM
            MAKE-STRUCTURE-SLOT-BOUNDP-FUNCTION TWO-CLASS-CACHE
            SLOT-INITARGS-FROM-STRUCTURE-SLOTD INITIAL-P
            COMPUTE-CLASS-SLOTS BUILT-IN-OR-STRUCTURE-WRAPPER1
            EARLY-METHOD-STANDARD-ACCESSOR-P MAKE-CONSTANT-FUNCTION
            N-N-P TWO-CLASS-ACCESSOR-TYPE TYPE-CLASS
            EARLY-CLASS-NAME-OF MAKE-PV-TABLE-TYPE-DECLARATION
            TWO-CLASS-INDEX FUNCTION-PRETTY-ARGLIST
            FUNCTION-RETURNING-T EARLY-CLASS-DIRECT-SUBCLASSES
            GET-MAKE-INSTANCE-FUNCTION-SYMBOL ONE-CLASS-WRAPPER0
            FORCE-CACHE-FLUSHES GET-MAKE-INSTANCE-FUNCTION
            ALLOCATE-CACHE-VECTOR SORT-SLOTS TWO-CLASS-WRAPPER0
            CPD-AFTER GF-INFO-SIMPLE-ACCESSOR-TYPE SORT-CALLS
            FLUSH-CACHE-VECTOR-INTERNAL EXPAND-SHORT-DEFCOMBIN
            COMPUTE-LINE-SIZE SYMBOL-PKG-NAME ONE-INDEX-CACHE
            MAKE-CALL-METHODS GF-PRECOMPUTE-DFUN-AND-EMF-P
            ...
            CHECKING-P ECD-CLASS-NAME INITIAL-DISPATCH-CACHE)) 
(PROCLAIM
...
(PROCLAIM
    '(FTYPE (FUNCTION (T *) T) CAPITALIZE-WORDS
            ...
            ITERATE::FUNCTION-LAMBDA-P ITERATE::MAYBE-WARN MAKE-WRAPPER
            FIND-CLASS)) 
(PROCLAIM
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T) T) VARIABLE-LEXICAL-P
            WALKER::WALK-REPEAT-EVAL VARIABLE-SPECIAL-P
            ...
            COMPUTE-CALLS SYSTEM:%SET-COMPILED-FUNCTION-NAME
            ...
            ADD-METHOD SWAP-WRAPPERS-AND-SLOTS ITERATE::MV-SETQ
            ...
            METHOD-FUNCTION-RETURNING-T VARIABLE-CLASS SLOT-EXISTS-P
            MAKE-PLIST REMTAIL DESTRUCTURE-INTERNAL
            ACCESSOR-MISS-FUNCTION UPDATE-INITIALIZE-INFO-INTERNAL
            N-N-DFUN-INFO MAKE-CAXR STANDARD-INSTANCE-ACCESS MAKE-CDXR
             CHECKING-DFUN-INFO
            MAKE-PV-TABLE-INTERNAL FIND-SLOT-DEFINITION REMOVE-METHOD
