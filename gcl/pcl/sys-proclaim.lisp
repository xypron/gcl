...
(PROCLAIM
    '(FTYPE (FUNCTION (T T T) T) SKIP-FAST-SLOT-ACCESS-P
            ...
            COMPUTE-EFFECTIVE-METHOD CONVERT-TABLE MAKE-METHOD-SPEC
            ...
            SORT-APPLICABLE-METHODS SORT-METHODS FIRST-FORM-TO-LISP
            ...
            MAP-ALL-ORDERS CAN-OPTIMIZE-ACCESS NOTE-PV-TABLE-REFERENCE
            |(FAST-METHOD WRAPPER-FETCHER (FUNCALLABLE-STANDARD-CLASS))|
            WALKER::RELIST-INTERNAL OPTIMIZE-SLOT-VALUE MAKE-DFUN-CALL
            |(FAST-METHOD SLOTS-FETCHER (FUNCALLABLE-STANDARD-CLASS))|
            WALKER::WALK-TAGBODY-1 OPTIMIZE-SET-SLOT-VALUE
            WALKER::WALK-LAMBDA
            |(FAST-METHOD RAW-INSTANCE-ALLOCATOR (FUNCALLABLE-STANDARD-CLASS))|
            OPTIMIZE-GF-CALL-INTERNAL DECLARE-STRUCTURE
            WALKER::WALK-COMPILER-LET OPTIMIZE-SLOT-BOUNDP
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T T T T) T) EXPAND-EMF-CALL-METHOD MAKE-FGEN
...
(PROCLAIM
    '(FTYPE (FUNCTION (*) T) TRUE |__si::MAKE-DFUN-INFO|
...
(PROCLAIM
    '(FTYPE (FUNCTION (T *) *) COERCE-TO-CLASS GET-METHOD-FUNCTION
            ...
            ENSURE-CLASS WALK-FORM MACROEXPAND-ALL
            ENSURE-GENERIC-FUNCTION)) 
(PROCLAIM
    '(FTYPE (FUNCTION (T) T) INITIAL-DISPATCH-CACHE CHECK-CACHE
            DISPATCH-CACHE CLASS-FROM-TYPE INTERN-EQL-SPECIALIZER
            DEFAULT-METHOD-ONLY-CACHE DNET-METHODS-P
            ACCESSOR-DFUN-INFO-CACHE METHOD-FUNCTION-FROM-FAST-FUNCTION
            ONE-INDEX-DFUN-INFO-CACHE EXTRACT-LAMBDA-LIST
            ...
            TWO-CLASS-ACCESSOR-TYPE TWO-CLASS-INDEX
            EXTRACT-SPECIALIZER-NAMES GET-MAKE-INSTANCE-FUNCTION-SYMBOL
            ALLOCATE-CACHE-VECTOR TWO-CLASS-WRAPPER0
            GF-INFO-SIMPLE-ACCESSOR-TYPE FLUSH-CACHE-VECTOR-INTERNAL
            COMPUTE-LINE-SIZE ONE-INDEX-CACHE
            GF-PRECOMPUTE-DFUN-AND-EMF-P EARLY-CLASS-NAME
            CANONICAL-SLOT-NAME ONE-INDEX-ACCESSOR-TYPE
            COMPILE-LAMBDA-UNCOMPILED GF-INFO-STATIC-C-A-M-EMF
            ONE-INDEX-INDEX GF-LAMBDA-LIST WALKER::GET-WALKER-TEMPLATE
            INTERN-FUNCTION-NAME CACHING-CACHE CHECKING-P
            CHECKING-CACHE CONSTANT-VALUE-CACHE EARLY-CLASS-SLOTS
            COMPILE-LAMBDA-DEFERRED GF-INFO-C-A-M-EMF-STD-P
            FUNCALLABLE-INSTANCE-P STRUCTURE-TYPE-INTERNAL-SLOTDS
            SHOW-DFUN-COSTS GF-INFO-FAST-MF-P
            RESET-CLASS-INITIALIZE-INFO UNDEFMETHOD-1 GET-CACHE-VECTOR
            EARLY-COLLECT-CPL CONSTANT-SYMBOL-P EARLY-COLLECT-SLOTS
            FREE-CACHE-VECTOR ARG-INFO-P
            STRUCTURE-SLOTD-READER-FUNCTION EARLY-METHOD-LAMBDA-LIST
            METHOD-LL->GENERIC-FUNCTION-LL ARG-INFO-VALID-P
            FAST-METHOD-CALL-ARG-INFO DFUN-ARG-SYMBOL
            EARLY-COLLECT-DEFAULT-INITARGS EARLY-METHOD-CLASS
            ARG-INFO-NKEYS EARLY-GF-P ECD-SUPERCLASS-NAMES
            EARLY-GF-NAME FORMAT-CYCLE-REASONS GF-DFUN-CACHE
            CACHING-DFUN-INFO GF-DFUN-INFO
            COMPUTE-APPLICABLE-METHODS-EMF-STD-P METHOD-CALL-P
            CONSTANT-VALUE-DFUN-INFO STRUCTURE-SLOT-BOUNDP
            RESET-CLASS-INITIALIZE-INFO-1 FUNCTION-RETURNING-NIL
            FREE-CACHE ITERATE::SEQUENCE-ACCESSOR PARSE-SPECIALIZERS
            ACCESSOR-DFUN-INFO-ACCESSOR-TYPE RESET-INITIALIZE-INFO
            ECD-CANONICAL-SLOTS EVAL-FORM EARLY-METHOD-QUALIFIERS
            ONE-INDEX-DFUN-INFO-INDEX
            PROCLAIM-INCOMPATIBLE-SUPERCLASSES ECD-OTHER-INITARGS
            WRAPPER-OF SLOT-INITARGS-FROM-STRUCTURE-SLOTD
            EARLY-METHOD-STANDARD-ACCESSOR-P TYPE-CLASS
            FUNCTION-PRETTY-ARGLIST ONE-CLASS-WRAPPER0
            GET-MAKE-INSTANCE-FUNCTION EXTRACT-PARAMETERS
            CHECK-WRAPPER-VALIDITY CLASS-PREDICATE UNPARSE-SPECIALIZERS
            EXTRACT-REQUIRED-PARAMETERS %SYMBOL-FUNCTION
            MAKE-CLASS-EQ-PREDICATE FINAL-ACCESSOR-DFUN-TYPE
            TWO-CLASS-WRAPPER1 COMPLICATED-INSTANCE-CREATION-METHOD
            MAKE-EQL-PREDICATE DEFAULT-STRUCTUREP CHECKING-FUNCTION
            ...
            GET-BUILT-IN-WRAPPER-SYMBOL GET-PV-CELL-FOR-CLASS
            DO-STANDARD-DEFSETF-1 STRUCTURE-TYPE-INCLUDED-TYPE-NAME
            CACHING-P STRUCTURE-TYPE-SLOT-DESCRIPTION-LIST GFS-OF-TYPE
            CACHE-P LEGAL-CLASS-NAME-P STRUCTURE-SLOTD-NAME
            STRUCTURE-TYPE-P STRUCTURE-SLOTD-ACCESSOR-SYMBOL
            CONSTANT-VALUE-P SFUN-P USE-DEFAULT-METHOD-ONLY-DFUN-P
            DEFAULT-SECONDARY-DISPATCH-FUNCTION
            INITIALIZE-INFO-CACHED-COMBINED-INITARGS-FORM-LIST
            STRUCTURE-SLOTD-WRITER-FUNCTION WRAPPER-FIELD
            FIND-CYCLE-REASONS NEXT-WRAPPER-FIELD
            EARLY-CLASS-DEFINITION SETFBOUNDP ECD-SOURCE
            GET-SETF-FUNCTION-NAME ECD-METACLASS USE-CACHING-DFUN-P
            CPD-CLASS MAKE-PV-TYPE-DECLARATION
            EARLY-CLASS-PRECEDENCE-LIST MAKE-CALLS-TYPE-DECLARATION
            METHODS-CONTAIN-EQL-SPECIALIZER-P MAP-SPECIALIZERS
            MAKE-TYPE-PREDICATE SLOT-VECTOR-SYMBOL CPD-SUPERS
            MAKE-PERMUTATION-VECTOR DEFAULT-TEST-CONVERTER
            STRUCTURE-OBJECT-P EXPAND-LONG-DEFCOMBIN
            EXPAND-MAKE-INSTANCE-FORM INITIAL-P MAKE-CONSTANT-FUNCTION
            EARLY-CLASS-NAME-OF FUNCTION-RETURNING-T
            FORCE-CACHE-FLUSHES SORT-SLOTS CPD-AFTER SORT-CALLS
            EXPAND-SHORT-DEFCOMBIN SYMBOL-PKG-NAME MAKE-CALL-METHODS
            CLASS-HAS-A-FORWARD-REFERENCED-SUPERCLASS-P
            DEFAULT-CONSTANT-CONVERTER INITIALIZE-INFO-BOUND-SLOTS
            ...
            STRUCTURE-SLOTD-TYPE VARIABLE-GLOBALLY-SPECIAL-P
...
(PROCLAIM
    '(FTYPE (FUNCTION (T *) T) CAPITALIZE-WORDS
            ...
            FIND-CLASS)) 
(PROCLAIM
    '(FTYPE (FUNCTION (T T) T) MAKE-CAXR MAKE-CDXR CHECKING-DFUN-INFO
            ...
            MEC-ALL-CLASSES %SET-CCLOSURE-ENV ADD-METHOD
            MEC-ALL-CLASS-LISTS REDEFINE-FUNCTION METHODS-CONVERTER
            COMPUTE-LAYOUT NO-SLOT PV-WRAPPERS-FROM-ALL-WRAPPERS
            ...
            MAKE-EARLY-ACCESSOR DOCTOR-DFUN-FOR-THE-DEBUGGER
            COMPUTE-STD-CPL |SETF PCL GDEFINITION|
            MAKE-DISCRIMINATING-FUNCTION-ARGLIST ADD-FORMS
            CPL-INCONSISTENT-ERROR FUNCALLABLE-STANDARD-INSTANCE-ACCESS
            ...
            SLOT-EXISTS-P CANONICALIZE-DEFCLASS-OPTION SET-WRAPPER
            DEAL-WITH-ARGUMENTS-OPTION PARSE-QUALIFIER-PATTERN
            SWAP-WRAPPERS-AND-SLOTS ITERATE::MV-SETQ
            MAKE-UNORDERED-METHODS-EMF STANDARD-INSTANCE-ACCESS
            CLASS-MIGHT-PRECEDE-P ITERATE::EXTRACT-SPECIAL-BINDINGS
            ...
            REMOVE-METHOD SET-FUNCALLABLE-INSTANCE-FUNCTION
            VARIABLE-LEXICAL-P VARIABLE-SPECIAL-P DO-SATISFIES-DEFTYPE
            MEMF-CONSTANT-CONVERTER COMPUTE-CONSTANTS
            SYSTEM:%SET-COMPILED-FUNCTION-NAME CLASS-CAN-PRECEDE-P
            SAUT-NOT-CLASS SAUT-NOT-CLASS-EQ SAUT-NOT-PROTOTYPE
            GF-MAKE-FUNCTION-FROM-EMF SAUT-NOT-EQL
            ...
            UPDATE-INITIALIZE-INFO-INTERNAL N-N-DFUN-INFO)) 
