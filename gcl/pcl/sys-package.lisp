...
(LISP::IMPORT
    '(LISP::CDDAR LISP::SHIFTF LISP::REMHASH LISP::CHAR-EQUAL
         ...
         LISP::PRINC LISP::NSUBST LISP::SIMPLE-VECTOR LISP::FBOUNDP
         ...
         LISP::NOTINLINE LISP::SET-MACRO-CHARACTER
         LISP::GET-MACRO-CHARACTER LISP::POP LISP::LIST-ALL-PACKAGES
         ...
         LISP::BYTE LISP::CHAR LISP::CONJUGATE LISP::CHAR-CODE-LIMIT
         LISP::CHAR-FONT-LIMIT LISP::SERIOUS-CONDITION LISP::CDAR
         ...
         LISP::SET-DISPATCH-MACRO-CHARACTER
         LISP::GET-DISPATCH-MACRO-CHARACTER LISP::STRING> LISP::GO
         ...
         LISP::MOST-NEGATIVE-SINGLE-FLOAT
         LISP::MOST-NEGATIVE-DOUBLE-FLOAT
         LISP::MOST-NEGATIVE-LONG-FLOAT LISP::MULTIPLE-VALUE-CALL
         LISP::TYPE-OF LISP::TAG LISP::&AUX LISP::TAGBODY
         LISP::SIMPLE-STRING-P LISP::READTABLE LISP::READTABLEP
         ...
         LISP::LISTP LISP::CHARACTER LISP::CHARACTERP
         ...
         LISP::PHASE LISP::CAAAR LISP::CTYPECASE LISP::ETYPECASE
         ...
         LISP::LONG-SITE-NAME LISP::NSTRING-UPCASE
         LISP::LONG-FLOAT-EPSILON LISP::LONG-FLOAT-NEGATIVE-EPSILON
         LISP::*BREAK-ENABLE* LISP::BIT-NAND LISP::ALPHANUMERICP
         LISP::FROUND LISP::LAMBDA-LIST-KEYWORDS LISP::CDADAR
         LISP::LENGTH LISP::OR WALKER::VARIABLE-GLOBALLY-SPECIAL-P
         LISP::TWO-WAY-STREAM LISP::COSH LISP::CAADAR LISP::WRITE-BYTE
         LISP::RATIONALP LISP::FIND LISP::SUBSTITUTE-IF-NOT
         LISP::DEPOSIT-FIELD LISP::FLOATING-POINT-OVERFLOW
         LISP::FLOATING-POINT-UNDERFLOW LISP::WITH-OPEN-FILE
         LISP::BOOLE-ANDC2 LISP::IF LISP::RATIONAL LISP::PARSE-INTEGER
         LISP::SFUN LISP::MOST-POSITIVE-SHORT-FLOAT
         LISP::MOST-POSITIVE-SINGLE-FLOAT
         LISP::MOST-POSITIVE-DOUBLE-FLOAT
         LISP::MOST-POSITIVE-LONG-FLOAT LISP::PSETQ LISP::COMPILE
         ...
         LISP::PACKAGE-USE-LIST LISP::PACKAGE-USED-BY-LIST LISP::SUBLIS
         ...
         LISP::SEVENTH LISP::DOUBLE-FLOAT-EPSILON
         LISP::DOUBLE-FLOAT-NEGATIVE-EPSILON LISP::VARIABLE
         ...
         LISP::LEAST-POSITIVE-NORMALIZED-SINGLE-FLOAT
         LISP::LEAST-POSITIVE-NORMALIZED-DOUBLE-FLOAT
         LISP::LEAST-POSITIVE-NORMALIZED-LONG-FLOAT LISP::FINISH-OUTPUT
         LISP::PROCLAIM LISP::BASE-STRING LISP::MAKE-STRING
         ...
         LISP::STRING-CHAR-P LISP::*LOAD-VERBOSE* LISP::STRING-UPCASE
         LISP::STRING-DOWNCASE LISP::DELETE-IF LISP::HOST-NAMESTRING
         ...
         LISP::BOOLE-ORC1 LISP::BOOLE-ORC2 LISP::ARRAY-TOTAL-SIZE-LIMIT
         ...
         LISP::GETF LISP::READ-CHAR LISP::PEEK-CHAR
         LISP::STRING-NOT-GREATERP LISP::ENOUGH-NAMESTRING LISP::SUBSEQ
         LISP::BASE-CHAR LISP::MAKE-CHAR LISP::NAME-CHAR
         ...
         LISP::STRING-NOT-LESSP LISP::CLASS LISP::PRIN1-TO-STRING
...
(LISP::IMPORT
    '(LISP::CDDAR LISP::SHIFTF LISP::REMHASH LISP::CHAR-EQUAL
         ...
         LISP::CONJUGATE LISP::CHAR-CODE-LIMIT LISP::CHAR-FONT-LIMIT
         ...
         LISP::*BREAK-ENABLE* LISP::BIT-NAND LISP::ALPHANUMERICP
         LISP::FROUND LISP::LAMBDA-LIST-KEYWORDS LISP::CDADAR
         LISP::LENGTH LISP::OR LISP::TWO-WAY-STREAM LISP::COSH
         LISP::CAADAR LISP::WRITE-BYTE LISP::RATIONALP LISP::FIND
         LISP::SUBSTITUTE-IF-NOT LISP::DEPOSIT-FIELD
         LISP::FLOATING-POINT-OVERFLOW LISP::FLOATING-POINT-UNDERFLOW
         LISP::WITH-OPEN-FILE LISP::BOOLE-ANDC2 LISP::IF LISP::RATIONAL
         LISP::PARSE-INTEGER LISP::SFUN LISP::MOST-POSITIVE-SHORT-FLOAT
         LISP::MOST-POSITIVE-SINGLE-FLOAT
         LISP::MOST-POSITIVE-DOUBLE-FLOAT
         LISP::MOST-POSITIVE-LONG-FLOAT LISP::PSETQ LISP::COMPILE
         LISP::VALUES-LIST LISP::GRAPHIC-CHAR-P LISP::LOCALLY
         ...
         LISP::MULTIPLE-VALUE-SETQ LISP::PRIN1 LISP::PACKAGE-USE-LIST
         LISP::PACKAGE-USED-BY-LIST LISP::SUBLIS LISP::SCHAR
         LISP::MAKE-ECHO-STREAM LISP::INLINE LISP::DECLAIM
         LISP::SCALE-FLOAT LISP::*PRINT-LENGTH* LISP::PROG
         LISP::SHORT-FLOAT-EPSILON LISP::SHORT-FLOAT-NEGATIVE-EPSILON
         LISP::&WHOLE LISP::INPUT-STREAM-P LISP::SIMPLE-BASE-STRING
         LISP::PROG* LISP::DECODE-UNIVERSAL-TIME
         ...
         LISP::OBJECT LISP::PROGRAM-ERROR LISP::NINTERSECTION
         LISP::ASINH LISP::IGNORE LISP::BOOLE-CLR LISP::SET-CHAR-BIT
         LISP::BIT-NOT LISP::SINGLE-FLOAT-EPSILON
         LISP::SINGLE-FLOAT-NEGATIVE-EPSILON LISP::MULTIPLE-VALUE-LIST
...
(LISP::IMPORT
    '(LISP::EXP LISP::DEFVAR LISP::DISASSEMBLE LISP::DELETE-IF
         ...
         LISP::ARRAY-RANK-LIMIT SYSTEM::INFO-SUBFILE SYSTEM::TKERROR
         LISP::RENAME-FILE LISP::READ-CHAR LISP::PEEK-CHAR
         LISP::REMOVE-DUPLICATES LISP::BYTE LISP::*MODULES*
         LISP::GET-OUTPUT-STREAM-STRING LISP::MULTIPLE-VALUE-BIND
         LISP::VECTORP LISP::RASSOC-IF-NOT LISP::UNINTERN
         SLOOP::LOOP-FINISH LISP::SPECIFIC-CORRECTABLE-ERROR
         LISP::CDADAR LISP::FUNCTION LISP::LOGORC2 LISP::*PACKAGE*
