...
TTL:;
	...
	base[2]= (V61);
	base[3]= VV[49];
	base[4]= CMPmake_fixnum((long)length((V60)));
	base[5]= (V60);
...
static void LnkT73(){ call_or_link(VV[73],(void **)(void *)&Lnk73);} /* ESCAPE-SPECIAL-CASES-REPLACE */
static void LnkT72(){ call_or_link(VV[72],(void **)(void *)&Lnk72);} /* ACCUMULATE-CASES */
