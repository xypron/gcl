...
(PROCLAIM
    '(FTYPE (FUNCTION (T T T) T) CJT BOOLE3 WT-INLINE-COND
            ...
            CHECK-FORM-TYPE C2FUNCALL-SFUN ADD-FAST-LINK
            INLINE-TYPE-MATCHES CJF C2LET)) 
(PROCLAIM
...
(PROCLAIM
    '(FTYPE (FUNCTION (T) *) SET-LOC T1EXPR C2EXPR C2PROGN T1EVAL-WHEN
            ...
            WT-SHORT-FLOAT-LOC)) 
(PROCLAIM
    '(FTYPE (FUNCTION (T) T) WT-VV WT-CAR WT-CDR DECLARATION-TYPE
            ...
            INFO-CHANGED-VARS C1EXPR C1UNWIND-PROTECT
...
(PROCLAIM
    '(FTYPE (FUNCTION (T *) T) UNWIND-EXIT WT-COMMENT CMPERR ADD-INIT
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T) T) INLINE-PROC SET-BDS-BIND UNWIND-BDS
