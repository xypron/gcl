...
T80:;
	...
	vs_top=sup;
	princ_char(10,Cnil);
	{object V24 = (VFUN_NARGS=0,(*(LnkLI120))());
	VMR3(V24)}
	goto T98;
T98:;
	V15= (long)(V15)-(1);
...
{	 VMB8 VMS8 VMV8
	goto TTL;
TTL:;
	{object V75 = (VFUN_NARGS=2,(*(LnkLI122))(Cnil,Cnil));
	VMR8(V75)}
	return Cnil;
}
...
T282:;
	...
	if((vs_base[0])==Cnil){
	goto T286;}
	setq(VV[26],(VFUN_NARGS=2,(*(LnkLI125))((V81),symbol_value(VV[26]))));
	goto T286;
T286:;
	V80= cdr((V80));
	V81= car((V80));
...
T317:;
	...
	goto T315;
T315:;
	V91= (VFUN_NARGS=4,(*(LnkLI126))(VV[27],(V84),VV[28],V90));
...
TTL:;
	...
	V108= (VFUN_NARGS=2,(*(LnkLI129))(VV[33],(V103)));
...
T437:;
	...
	(void)((VFUN_NARGS=2,(*(LnkLI137))(/* INLINE-ARGS */V141,symbol_value(VV[47]))));
	goto T430;
T430:;
	(void)((*(LnkLI138))(car((V136))));
	V136= cdr((V136));
	goto T426;
	goto T427;
T427:;
...
T466:;
	...
	V156= (VFUN_NARGS=3,(*(LnkLI139))(V158,VV[50],VV[51]));
...
T488:;
	...
	{object V182 = (*(LnkLI141))((V181),VV[54]);
	VMR19(V182)}}
	goto T460;
T460:;
	{object V183 = Cnil;
...
T550:;
	...
	goto T557;
T557:;
	setq(VV[56],(*(LnkLI140))((V192),(V195),(V197)));
	(void)((VFUN_NARGS=2,(*(LnkLI122))(symbol_value(VV[56]),(V191))));
	{object V203 = VV[55];
	VMR21(V203)}
	goto T554;
T554:;
...
TTL:;
	{object V225;
	V225= Cnil;
	V225= (VFUN_NARGS=2,(*(LnkLI145))((V221),(V222)));
	if(((V225))==Cnil){
	goto T610;}
	setq(VV[58],Cnil);
...
T616:;
	...
	goto T615;
T615:;
	V226= (*(LnkLI140))((V223),(V222),(V225));
	(void)((VFUN_NARGS=2,(*(LnkLI122))(/* INLINE-ARGS */V226,(V224))));
	{object V227 = Ct;
	VMR26(V227)}
	goto T610;
T610:;
...
TTL:;
	{object V233;
	V233= (VFUN_NARGS=0,(*(LnkLI144))());
	{object V234;
	V234= get((V233),VV[49],Cnil);
	{object V235 = (*(LnkLI146))((V231),(V234),(V233),(V232));
	VMR27(V235)}}}
	return Cnil;
}
...
TTL:;
	{object V240;
	V240= (VFUN_NARGS=0,(*(LnkLI144))());
	if(!(eql(cdr(symbol_value(VV[61])),(V240)))){
	goto T624;}
	{object V241;
	V241= get((V240),VV[49],Cnil);
	{object V242 = (*(LnkLI146))((V238),(V241),(V240),(V239));
	VMR28(V242)}}
	goto T624;
T624:;
	{object V243 = Cnil;
...
TTL:;
	{object V248;
	V248= (VFUN_NARGS=4,(*(LnkLI145))((V246),symbol_value(VV[53]),VV[63],VV[64]));
	base[0]= Ct;
	base[1]= VV[65];
	base[2]= (V248);
	vs_top=(vs_base=base+0)+3;
	...
	{object V250 = (VFUN_NARGS=2,(*(LnkLI122))(/* INLINE-ARGS */V249,(V247)));
	VMR29(V250)}}
	base[0]=base[0];
	return Cnil;
}
...
T716:;
	...
	V273= (*(LnkLI140))((V259),(V263),V272);
	V274= (*(LnkLI150))(/* INLINE-ARGS */V273);
	(void)((*(LnkLI149))(/* INLINE-ARGS */V274));
...
TTL:;
	...
	goto T730;
T730:;{object V278;
	V278= (VFUN_NARGS=2,(*(LnkLI145))(Cnil,symbol_value(VV[53])));
...
T733:;}
	...
	(void)((VFUN_NARGS=2,(*(LnkLI137))(Cnil,symbol_value(VV[53]))));
	V277= (V279);}
	goto T732;
T732:;
	{object V280;
...
TTL:;
	{object V290;
	V290= (VFUN_NARGS=4,(*(LnkLI145))(VV[71],(V289),VV[72],Ct));
	if(((V290))==Cnil){
	goto T744;}
	base[0]= (V289);
...
T753:;
	...
	base[0]= Ct;
	base[1]= VV[74];
	base[2]= make_fixnum((long)(*(LnkLI152))((V297),caddr((V296))));
	base[3]= (V297);
	vs_top=(vs_base=base+0)+4;
	Lformat();
	vs_top=sup;
...
T780:;
	...
	V317= (VFUN_NARGS=2,(*(LnkLI125))((V305),V314));
...
T968:;
	...
	bds_unwind1;
	bds_unwind1;
	{object V370 = symbol_value(VV[78]);
	VMR38(V370)}
	base[0]=base[0];
	return Cnil;
}
...
TTL:;
	{object V375;
	V375= (VFUN_NARGS=2,(*(LnkLI145))((V373),(V374)));
	if(((V375))==Cnil){
	goto T982;}
	V376= aref1((V374),0);
...
TTL:;
	...
	goto T985;
T985:;
	if(!((fix((V381)))<(fix(symbol_value(VV[86]))))){
	goto T986;}
...
TTL:;
	...
	V404= Cnil;
	V405= Cnil;
	V401= make_fixnum((long)(*(LnkLI159))(fix((V400))));
	if(!((fix((V399)))>=(0))){
	goto T1036;}
	{object V406;
	setq(VV[9],(VFUN_NARGS=2,(*(LnkLI160))((V399),(V400))));
	...
	{object V408 = (VFUN_NARGS=7,(*(LnkLI162))(V407,Ct,symbol_value(VV[9]),(V402),(V403),(V404),(V405)));
	VMR42(V408)}
	goto T1036;
T1036:;
...
TTL:;
	...
	V414= Cnil;
	V415= Cnil;
	if(!((fix((V410)))<(fix(symbol_value(VV[86]))))){
	goto T1067;}
	(void)((MVloc[(0)]=(Cnil)));
	(void)((MVloc[(1)]=(Cnil)));
	(void)((MVloc[(2)]=(Cnil)));
...
{	
	...
	V444= V443;
	narg = narg - 1;
	if (narg <= 0) goto T1146;
	else {
	V445= first;}
	--narg; goto T1147;
	goto T1146;
T1146:;
	V445= symbol_value(VV[88]);
	goto T1147;
T1147:;
...
{register object *base=vs_base;
	...
	if(vs_base>=vs_top){vs_top=sup;goto T1199;}
	V456=(base[0]);
	vs_base++;
	if(vs_base>=vs_top){vs_top=sup;goto T1200;}
	V457=(base[1]);
	vs_top=sup;
	goto T1201;
	goto T1199;
...
T1211:;
	...
	goto T1224;
T1224:;
	(void)((VFUN_NARGS=7,(*(LnkLI162))((V462),Cnil,(V457),(V458),(V460),(V459),(V461))));
...
T1247:;
	base[2]= symbol_value(VV[78]);
	base[3]= VV[90];{object V477;
	V477= car((V473));
	if(V477==Cnil)goto T1259;
	base[4]= V477;
	goto T1258;
	goto T1259;
T1259:;}
...
T1276:;
	...
	vs_top=sup;
	V485= vs_base[0];
	{register object x= car(V485),V484= VV[92];
	while(!endp(V484))
...
{	
	...
	V494= V487;
	narg = narg - 4;
	if (narg <= 0) goto T1281;
	else {
	V495= first;}
	if (--narg <= 0) goto T1282;
	else {
	V496= va_arg(ap,object);}
	if (--narg <= 0) goto T1283;
	else {
...
T1302:;
	...
	vs_top=sup;
	V499= vs_base[0];
	base[5]= (*(LnkLI168))(VV[96],small_fixnum(80),car(V499));
	goto T1304;
	goto T1306;
T1306:;
	base[5]= (*(LnkLI168))(VV[97],small_fixnum(80),(V493));
	goto T1304;
T1304:;
	vs_top=(vs_base=base+0)+6;
	Lformat();
...
T1325:;
	{object V527;
	object V528;
	V529= list(2,VV[105],(V523));
	base[3]= list(5,VV[104],/* INLINE-ARGS */V529,Cnil,Cnil,list(2,VV[105],(V524)));
	vs_top=(vs_base=base+3)+1;
	(void) (*Lnk169)();
	if(vs_base>=vs_top){vs_top=sup;goto T1335;}
	V527= vs_base[0];
	vs_base++;
	if(vs_base>=vs_top){vs_top=sup;goto T1336;}
	V528= vs_base[0];
	vs_top=sup;
	goto T1337;
	goto T1335;
...
static object  LnkTLI170(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[170],(void **)(void *)&LnkLI170,2,first,ap);va_end(ap);return V1;} /* SAFE-EVAL */
static void LnkT169(){ call_or_link(VV[169],(void **)(void *)&Lnk169);} /* ERROR-SET */
static object  LnkTLI168(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[168],(void **)(void *)&LnkLI168,3,first,ap);va_end(ap);return V1;} /* APPLY-DISPLAY-FUN */
static object  LnkTLI167(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[167],(void **)(void *)&LnkLI167,1,first,ap);va_end(ap);return V1;} /* COMPUTING-ARGS-P */
static void LnkT166(){ call_or_link(VV[166],(void **)(void *)&Lnk166);} /* VS-TOP */
static object  LnkTLI165(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[165],(void **)(void *)&LnkLI165,1,first,ap);va_end(ap);return V1;} /* NEXT-STACK-FRAME */
static object  LnkTLI164(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[164],(void **)(void *)&LnkLI164,1,first,ap);va_end(ap);return V1;} /* IHS-NOT-INTERPRETED-ENV */
static object  LnkTLI163(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[163],(void **)(void *)&LnkLI163,2,first,ap);va_end(ap);return V1;} /* GET-LINE-OF-FORM */
static object  LnkTLI162(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_vproc_new(VV[162],(void **)(void *)&LnkLI162,first,ap);va_end(ap);return V1;} /* PRINT-STACK-FRAME */
static object  LnkTLI161(){return call_proc0(VV[161],(void **)(void *)&LnkLI161);} /* SET-ENV */
static object  LnkTLI160(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_vproc_new(VV[160],(void **)(void *)&LnkLI160,first,ap);va_end(ap);return V1;} /* NTH-STACK-FRAME */
static object  LnkTLI159(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[159],(void **)(void *)&LnkLI159,4353,first,ap);va_end(ap);return V1;} /* DBL-WHAT-FRAME */
static object  LnkTLI158(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[158],(void **)(void *)&LnkLI158,1,first,ap);va_end(ap);return V1;} /* GET-NEXT-VISIBLE-FUN */
static void LnkT157(){ call_or_link(VV[157],(void **)(void *)&Lnk157);} /* STRING-MATCH */
static void LnkT156(){ call_or_link(VV[156],(void **)(void *)&Lnk156);} /* PACKAGE-SIZE */
static object  LnkTLI152(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[152],(void **)(void *)&LnkLI152,258,first,ap);va_end(ap);return V1;} /* RELATIVE-LINE */
static object  LnkTLI151(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[151],(void **)(void *)&LnkLI151,1,first,ap);va_end(ap);return V1;} /* SHORT-NAME */
static object  LnkTLI150(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[150],(void **)(void *)&LnkLI150,1,first,ap);va_end(ap);return V1;} /* INSERT-BREAK-POINT */
static object  LnkTLI149(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[149],(void **)(void *)&LnkLI149,1,first,ap);va_end(ap);return V1;} /* SHOW-BREAK-POINT */
static void LnkT148(){ call_or_link(VV[148],(void **)(void *)&Lnk148);} /* BREAK-FUNCTION */
static object  LnkTLI147(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[147],(void **)(void *)&LnkLI147,1,first,ap);va_end(ap);return V1;} /* DWIM */
static object  LnkTLI146(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[146],(void **)(void *)&LnkLI146,4,first,ap);va_end(ap);return V1;} /* MAYBE-BREAK */
static object  LnkTLI145(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_vproc_new(VV[145],(void **)(void *)&LnkLI145,first,ap);va_end(ap);return V1;} /* POSITION */
static object  LnkTLI144(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_vproc_new(VV[144],(void **)(void *)&LnkLI144,first,ap);va_end(ap);return V1;} /* CURRENT-STEP-FUN */
static object  LnkTLI143(){return call_proc0(VV[143],(void **)(void *)&LnkLI143);} /* INIT-BREAK-POINTS */
static void LnkT142(){ call_or_link(VV[142],(void **)(void *)&Lnk142);} /* IHS-FNAME */
static object  LnkTLI141(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[141],(void **)(void *)&LnkLI141,2,first,ap);va_end(ap);return V1;} /* ITERATE-OVER-BKPTS */
static object  LnkTLI140(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[140],(void **)(void *)&LnkLI140,3,first,ap);va_end(ap);return V1;} /* MAKE-BREAK-POINT */
static object  LnkTLI139(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_vproc_new(VV[139],(void **)(void *)&LnkLI139,first,ap);va_end(ap);return V1;} /* MAKE-ARRAY */
static object  LnkTLI138(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[138],(void **)(void *)&LnkLI138,1,first,ap);va_end(ap);return V1;} /* WALK-THROUGH */
static object  LnkTLI137(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_vproc_new(VV[137],(void **)(void *)&LnkLI137,first,ap);va_end(ap);return V1;} /* VECTOR-PUSH-EXTEND */
static void LnkT136(){ call_or_link(VV[136],(void **)(void *)&Lnk136);} /* INSTREAM-NAME */
static void LnkT135(){ call_or_link(VV[135],(void **)(void *)&Lnk135);} /* LOAD */
static object  LnkTLI134(){return call_proc0(VV[134],(void **)(void *)&LnkLI134);} /* SETUP-LINEINFO */
static object  LnkTLI133(){return call_proc0(VV[133],(void **)(void *)&LnkLI133);} /* CLEANUP */
static void LnkT130(){ call_or_link(VV[130],(void **)(void *)&Lnk130);} /* READ-FROM-STRING */
static object  LnkTLI129(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_vproc_new(VV[129],(void **)(void *)&LnkLI129,first,ap);va_end(ap);return V1;} /* COUNT */
static object  LnkTLI128(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_proc_new(VV[128],(void **)(void *)&LnkLI128,1,first,ap);va_end(ap);return V1;} /* GET-INSTREAM */
static void LnkT127(){ call_or_link(VV[127],(void **)(void *)&Lnk127);} /* STREAM-NAME */
static object  LnkTLI126(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_vproc_new(VV[126],(void **)(void *)&LnkLI126,first,ap);va_end(ap);return V1;} /* MAKE-INSTREAM */
static object  LnkTLI125(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_vproc_new(VV[125],(void **)(void *)&LnkLI125,first,ap);va_end(ap);return V1;} /* DELETE */
static void LnkT124(){ call_or_link(VV[124],(void **)(void *)&Lnk124);} /* CLOSEDP */
static object  LnkTLI122(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_vproc_new(VV[122],(void **)(void *)&LnkLI122,first,ap);va_end(ap);return V1;} /* BREAK-LEVEL */
...
static object  LnkTLI120(object first,...){object V1;va_list ap;va_start(ap,first);V1=call_vproc_new(VV[120],(void **)(void *)&LnkLI120,first,ap);va_end(ap);return V1;} /* BREAK-LOCALS */
