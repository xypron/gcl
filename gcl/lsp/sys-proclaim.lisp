...
(PROCLAIM
    '(FTYPE (FUNCTION (T T) FIXNUM) RELATIVE-LINE GET-NODE-INDEX
            THE-END ANSI-LOOP::DUPLICATABLE-CODE-P)) 
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T T) T) ANSI-LOOP::LOOP-STANDARD-EXPANSION
            ...
            SHARP-U-READER SHARP-A-READER KEY-LIST MAKE-T-TYPE
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T *) T) SUBSETP SLOOP::IN-ARRAY-SLOOP-FOR
            UNION DELETE DELETE-IF DELETE-IF-NOT EVERY FILL FIND
            ...
            SET-DIFFERENCE SET-EXCLUSIVE-OR SOME)) 
(PROCLAIM
...
(PROCLAIM
    '(FTYPE (FUNCTION NIL T) SLOOP::TYPE-ERROR TOP-LEVEL CLEANUP
            SETUP-LINEINFO ANSI-LOOP::LOOP-DO-WITH
            ...
            GET-INDEX-NODE DEFAULT-INFO-HOTLIST ANSI-LOOP::LOOP-CONTEXT
            ANSI-LOOP::LOOP-ITERATION-DRIVER ANSI-LOOP::LOOP-BIND-BLOCK
...
(PROCLAIM
    '(FTYPE (FUNCTION (*) *) BREAK-NEXT BREAK-LOCAL BREAK-BDS
            IHS-BACKTRACE SHOW-BREAK-VARIABLES SERROR::INF-SIGNAL LOC
            DBL-BACKTRACE ANSI-LOOP::LOOP-DISALLOW-CONDITIONAL
            ANSI-LOOP::LOOP-OPTIONAL-TYPE INFO-ERROR BREAK-QUIT
            BREAK-PREVIOUS BREAK-VS)) 
(PROCLAIM
...
(PROCLAIM
    '(FTYPE (FUNCTION (T) *) BREAK-GO ALOAD INFO-SUBFILE DESCRIBE
            INSTREAM-NAME INSPECT INSPECT-OBJECT WAITING
            GET-&ENVIRONMENT FIND-DECLARATIONS
            ANSI-LOOP::LOOP-OPTIMIZATION-QUANTITIES PRIN1-TO-STRING
            PRINC-TO-STRING ANSI-LOOP::LOOP-LIST-STEP IHS-FNAME
            END-WAITING ANSI-LOOP::NAMED-VARIABLE)) 
(PROCLAIM '(FTYPE (FUNCTION (T :DYNAMIC-EXTENT *) T) ADJUST-ARRAY)) 
(PROCLAIM
    '(FTYPE (FUNCTION (T T *) FIXNUM) COUNT-IF INTERNAL-COUNT-IF-NOT
            COUNT-IF-NOT VECTOR-PUSH-EXTEND INTERNAL-COUNT
...
(PROCLAIM
    '(FTYPE (FUNCTION (T) T) ANSI-LOOP::LOOP-PATH-INCLUSIVE-PERMITTED
            NODES-FROM-INDEX ANSI-LOOP::LOOP-PATH-FUNCTION
            ANSI-LOOP::LOOP-PATH-USER-DATA FIX-LOAD-PATH
            ...
            S-DATA-NAME BREAK-BACKWARD-SEARCH-STACK GET-INSTREAM
            ...
            ANSI-LOOP::MAKE-ANSI-LOOP-UNIVERSE NEXT-STACK-FRAME
            INFO-GET-FILE COMPUTING-ARGS-P ISQRT SEARCH-STACK
            ...
            INFO-GET-TAGS BKPT-FORM ANSI-LOOP::LOOP-MAKE-DESETQ
            SLOOP::TRANSLATE-NAME ANSI-LOOP::LOOP-MAKE-PSETQ
            ...
            SERROR::|ERROR-tester| NODE-OFFSET
            SERROR::|WRONG-TYPE-ARGUMENT-tester| COMPILE-FILE-PATHNAME
            INFO-NODE-FROM-POSITION SERROR::|TOO-FEW-ARGUMENTS-tester|
            COMPLEMENT SERROR::|TOO-MANY-ARGUMENTS-tester| CONSTANTLY
            ANSI-LOOP::LOOP-HACK-ITERATION
            SERROR::|UNEXPECTED-KEYWORD-tester| PHASE ABS
            ADD-TO-HOTLIST SERROR::|INVALID-FORM-tester| ACOS
            ...
            ARRAY-DIMENSIONS INSTREAM-STREAM-NAME ASIN ASINH
            ANSI-LOOP::LOOP-EMIT-BODY ATANH
            ...
            ANSI-LOOP::LOOP-UNIVERSE-TYPE-KEYWORDS SETUP-INFO
            ANSI-LOOP::LOOP-UNIVERSE-ANSI BEST-ARRAY-ELEMENT-TYPE
            SIMPLE-ARRAY-P BYTE-POSITION
            ANSI-LOOP::LOOP-UNIVERSE-IMPLICIT-FOR-REQUIRED FIND-CLASS
            BYTE-SIZE IHS-VISIBLE SLOOP::AVERAGING-SLOOP-MACRO
            NORMALIZE-TYPE SIGNUM KNOWN-TYPE-P SINH
            ...
            ANSI-LOOP::LOOP-LIST-COLLECTION ANSI-LOOP::LOOP-PATH-NAMES
...
(PROCLAIM
    '(FTYPE (FUNCTION (T *) *) DECODE-UNIVERSAL-TIME PRINT-DOC
            ...
            GET-SETF-METHOD-MULTIPLE-VALUE SHOW-INFO NLOAD
...
(PROCLAIM
    '(FTYPE (FUNCTION (T *) T) FILE-SEARCH WARN DELETE-DUPLICATES
            WARN-VERSION NTH-STACK-FRAME UPGRADED-ARRAY-ELEMENT-TYPE
            SLOOP::LOOP-ADD-TEMPS SLOOP::ADD-FROM-DATA MAKE-ARRAY
            ANSI-LOOP::LOOP-WARN BIT INFO-SEARCH LIST-MATCHES
            ARRAY-IN-BOUNDS-P FILE-TO-STRING ARRAY-ROW-MAJOR-INDEX
            REMOVE-DUPLICATES BIT-NOT SBIT BREAK-LEVEL
...
(PROCLAIM
    '(FTYPE (FUNCTION (T T) T) LIST-DELQ BREAK-STEP-INTO
            ...
            GET-NODES ANSI-LOOP::LOOP-DO-IF LISP::KEYWORD-SUPPLIED-P
            ...
            GET-LINE-OF-FORM INFO-AUX SAFE-EVAL LDB SETF-HELPER
            LDB-TEST LOGANDC1 LOGANDC2 LOGNAND LOGNOR LOGORC1
            COMPILER::COMPILER-DEF-HOOK SEQUENCE-CURSOR LOGORC2
            DM-NTH-CDR INCREMENT-CURSOR LOGTEST SLOOP::MAKE-VALUE
            SUBSTRINGP DM-V DM-NTH SLOOP::PARSE-LOOP-MAP
            SLOOP::THE-TYPE SLOOP::L-EQUAL MASK-FIELD DBL-UP SUPER-GO
            ...
            SLOOP::MINIMIZE-SLOOP-COLLECT GET-MATCH
            OVERWRITE-SLOT-DESCRIPTIONS SLOOP::COUNT-SLOOP-COLLECT
            SLOOP::THEREIS-SLOOP-COLLECT ANSI-LOOP::MAKE-LOOP-MINIMAX
            ...
            SUB-INTERVAL-P COERCE SLOOP::IN-TABLE-SLOOP-MAP ADD-FILE
            CHECK-SEQ-START-END GET-INFO-CHOICES
            SLOOP::IN-PACKAGE-SLOOP-MAP)) 